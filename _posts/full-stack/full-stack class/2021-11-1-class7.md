...
CREATE TABLE tbl_emp (
    empno number(4)      NOT NULL CONSTRAINT PK_TBLEMP_EMPNO2 PRIMARY KEY -- 컬럼레벨
    , email varchar2(50) NOT NULL CONSTRAINT UK_TBLEMP_EMAIL2 UNIQUE
    , ename varchar2(20) NOT NULL -- 컬럼레벨 NN
    , kor number(3) CONSTRAINT CK_TBLEMP_KOR2 CHECK(kor BETWEEN 0 AND 100)
    , city varchar2(20) CONSTRAINT CK_TBLEMP_KOR CHECK(city IN ('부산', '대구', '서울', '대전', '인천'))
...
CREATE TABLE tbl_emp (
    ...
    , CONSTRAINT CK_TBLEMP_KOR CHECK(city IN ('부산', '대구', '서울', '대전', '인천'
