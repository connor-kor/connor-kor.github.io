...
```sql
SELECT count(decode(mod(substr(ssn, 8, 1), 2), 1, 'O')) AS 남자사원수
...
JOB                1          2          3          4          5          6          7          8     
--------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---------- ---
CLERK              1          0          0          0          0          0          0          0     
SALESMAN           0          2          0          0          0          0          0          0     PRESIDENT          0          0          0          0          0          0          0          0     MANAGER            0          0          0          1          1          1          0          0     ANALYST            0          0          0          0          0          0          0          0     
```
...
```
0.05605172170155808704001740919482338839	91.154722955365356972530074515237299058	ZNUPW
```
...
- `dbms_random` 오라클의 패키지의 `value` 함수: 0~1 난수를 불러온다.
- `value(0, 100)` 0~100 사이 난수를 불러온다.
- `string('형식', n)` 대/소문자 문자 n 개

```
U		L		A		X		P
---------------------------------------
VTMTQ	rsstv	XKIQg	YFY1E	elQqV
```
