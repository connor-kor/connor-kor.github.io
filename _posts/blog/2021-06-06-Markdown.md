...
[naver](https://naver.com "Go to Naver"){:target="_blank"}

마우스를 가져다대면 Go to Naver 글귀를 나타냅니다.

\[link keyword](URL "Optional Title here") : 외부링크 = 대괄호 + 괄호

<https://naver.com>{:target="_blank"}
...
<[Shortcut Keys (typora.io)](https://support.typora.io/Shortcut-Keys/#change-shortcut-keys){:target="_blank"}> 
